...
function addEle(data,tmp1,tmp) {
    for (var i in data){
        ...
        if(mode.status==1){
            ...
            $("#td-change"+tmp1+i).append('<div id="am-btn-danger-l4'+tmp1+i+'" className="am-btn am-btn-danger anniu"><a style="color: #fff" onclick="closeOrder('+mode.oCode+')" href="commentlist.html?code='+mode.oCode+'">评价二手物品</a></div>');
