...
function addEle(data) {
    ...
    if(data.status==2){
        ...
        $("#td-change").append('<div id="am-btn-danger-l4" className="am-btn am-btn-danger anniu"><a style="color: #fff" onclick="closeOrder('+data.oCode+')" href="commentlist.html?code='+data.oCode+'">评价二手物品</a></div>');
